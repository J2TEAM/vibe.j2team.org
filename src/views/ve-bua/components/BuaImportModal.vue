...
<template>
  <section v-if="props.open" class="absolute inset-0 z-[60] grid place-items-center bg-bg-deep/85 p-4">
    <div class="w-full max-w-2xl border border-border-default bg-bg-surface p-4">
      <div class="mb-3 flex items-center justify-between">
        <h3 class="font-display text-sm uppercase tracking-wider text-text-primary">Import mã bùa</h3>
        <button
      ...
      <textarea
        ...
        placeholder="Dán mã dạng BUA-S1.xxxxx hoặc BUA-D1.xxxxx"
