...
<template>
  <div v-if="props.open" class="pointer-events-auto w-[340px] border border-border-default bg-bg-surface p-3">
    <button
    ...
    <label class="block">
      <span class="mb-1 block text-xs uppercase tracking-wider text-text-dim">Số trục đối xứng: {{ props.axisCount }}</span>
      <input
    ...
    <label class="mt-2 flex items-center justify-between gap-2 border border-border-default px-3 py-2 text-sm">
