...
export class Input {
  ...
  private touchActions = {
    attack: false, block: false, ranged: false,
  ...
  private isGameKey(code: string): boolean {
    return ['Space', 'ShiftLeft', 'ShiftRight', 'KeyE', 'KeyF',
            'KeyW', 'KeyA', 'KeyS', 'KeyD',
            'ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight',
            'Escape', 'KeyP'].includes(code)
  }
  ...
  getState(): InputState {
    return {
      ...
      blockJustPressed: this.justPressed('ShiftLeft') || this.justPressed('ShiftRight') || this.touchActionsJust.block,
      ...
      pauseJustPressed: this.justPressed('Escape') || this.justPressed('KeyP') || this.touchActionsJust.pause,
    }
  }
  ...
  setTouchAction(action: 'attack' | 'block' | 'ranged' | 'interact' | 'pause', pressed: boolean): void {
