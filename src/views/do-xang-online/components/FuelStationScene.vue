...
import { useStationAnimation } from '../composables/useStationAnimation'
...
type FuelPick = { label: string; pricePerLiter: number }
...
const {
  hosePathD, hoseVisualFillPercent, progressHero, pulseHero,
  attendantOuterStyle, pumpIslandSceneStyle, hoseLayerWrapStyle,
  hoseLayerMotionStyle, attendantInnerMotionClass, hoseStrokeMotionClass,
  attendantWalking, showHoseInScene, showAttendantGrayCoil, spiralMeterPercent,
  isCar, vehicleImageSrc, pumpVibrate, nozzleGlow,
  showNozzleStream, showDrops, refuelHelper, showTankBar,
  stationStateLabel, progressHeroKey,
} = useStationAnimation({
  vehicle: props.vehicle,
  fuel: props.fuel,
  canPump: props.canPump,
  fillingState: props.fillingState,
  sessionWalkMs: props.sessionWalkMs,
  sessionElapsedMs: props.sessionElapsedMs,
  hoseSessionKey: props.hoseSessionKey,
  attendantAtVehicle: props.attendantAtVehicle,
  fillPhaseCode: props.fillPhaseCode,
  hoseLinePercent: props.hoseLinePercent,
  progressPercent: props.progressPercent,
  pulseArmed: props.pulseArmed,
  prefersReducedMotion: props.prefersReducedMotion,
  dropSeeds: props.dropSeeds,
  isUsingFallback: props.isUsingFallback,
  isParked: props.isParked,
  isParking: props.isParking,
  parkingProgress01: props.parkingProgress01,
})
