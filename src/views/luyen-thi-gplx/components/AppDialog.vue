    ...
    <div v-if="dialogState.isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div v-if="dialogState.imageUrl" class="mb-6 flex justify-center">
          <div
            class="w-full max-h-64 border border-border-default bg-bg-deep flex items-center justify-center p-4"
          >
            <img
        ...
        <div v-if="dialogState.footer" class="mb-6">
          <div
            class="inline-flex bg-accent-coral/10 text-accent-coral px-3 py-1 font-mono text-xs font-bold border border-accent-coral/20"
          >
            {{ dialogState.footer }}
          </div>
        </div>
