...
<template>
  <div
    class="flex flex-col items-center justify-center p-8 max-w-lg mx-auto text-center border border-border-default bg-bg-surface animate-fade-up"
  >
    ...
    <div class="flex flex-col gap-3 w-full border-t border-border-default pt-6">
      <h3 class="font-display text-sm tracking-widest text-text-dim mb-2 uppercase">
