...
function drawUI() {
  ...
  ctx.fillText('NINJA', 18, 28)
  ctx.fillStyle = '#fbbf24'
  ctx.font = '10px monospace'
  ctx.fillText(`Lv.${level.value}`, 110, 28)
  ctx.fillStyle = '#94a3b8'
  ctx.font = '9px monospace'
  ctx.fillText(biome.name, 140, 28)
...
function drawGameOver() {
  ...
  ctx.font = '14px monospace'
  ctx.fillText(
    `Level: ${level.value} | Kills: ${killCount.value} | Biome: ${getBiomeConfig(level.value).name}`,
    W / 2,
    H / 2,
  )
