...
const hasStartedRun = computed<boolean>(
  () => logs.value.length > 0 || round.value > 1 || isFinished.value,
)
...
<template>
  ...
  >
    ...
    <div class="mx-auto flex w-full max-w-6xl flex-col gap-6">
      ...
      >
        <div class="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h2 class="mt-1 font-display text-xl text-text-primary sm:text-2xl">
              Bạn mới vào? Chơi theo 4 bước này
            </h2>
          </div>
          <button
            type="button"
        ...
        <div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <div class="border border-border-default bg-bg-deep p-3">
            ...
            <p class="mt-1 text-sm text-text-secondary">
              Đọc <span class="text-text-primary">Priority Brief</span> để biết mục tiêu vòng hiện
              tại.
            </p>
          </div>
          <div class="border border-border-default bg-bg-deep p-3">
            ...
            <p class="mt-1 text-sm text-text-secondary">
              Vào khung Incident, chọn 1 phương án có trade-off hợp lý.
            </p>
          </div>
          <div class="border border-border-default bg-bg-deep p-3">
            ...
            <p class="mt-1 text-sm text-text-secondary">
              Quan sát 4 chỉ số
              <span class="text-text-primary">Stability / Trust / Energy / Chaos</span>.
            </p>
          </div>
          <div class="border border-border-default bg-bg-deep p-3">
            <p class="text-xs tracking-widest text-accent-coral">BƯỚC 4</p>
            <p class="mt-1 text-sm text-text-secondary">
              Sau vài vòng, mở Tactical/Learning để tối ưu chiến thuật sâu hơn.
            </p>
          </div>
        </div>
      </section>
      ...
      <!-- Game Content -->
      <section
        id="incident-playground"
        class="section-game-content grid gap-5 lg:grid-cols-[1.35fr_1fr]"
      >
        <!-- Left: Incident -->
        <article
